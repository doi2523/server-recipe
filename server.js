...
//   database: "recipes_db", // Tên cơ sở dữ liệu
// });
// Kết nối MySQL
const db = mysql.createConnection({
  host: "bugkevwn8ykrf6zagltk-mysql.services.clever-cloud.com",
  user: "ug8auirufmyqcpc4", // Thay đổi nếu cần
  password: "NfnQJznTnadNTGLCMk8a", // Thay đổi nếu cần
  database: "bugkevwn8ykrf6zagltk", // Tên cơ sở dữ liệu
});
